...
export const SETTINGS_SECTIONS: SettingsSectionDef[] = [
  ...
  },
  {
    ...
    cards: [
      ...
      {
        title: "Call Scripts",
        desc: "Phone-call scripts shown to admins in the Power Dialer when a call connects",
        icon: "📝",
        href: "/settings/call-scripts",
      },
      {
        title: "Call Dispositions",
        desc: "Customize the call-outcome buttons in the dialer and what each one does",
        icon: "☎",
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        desc: "Tracked calls land in Call Reports with the ad that made the phone ring; unknown callers become leads",
        icon: "📈",
  ...
  },
  {
    ...
    cards: [
      ...
      {
      title: "Trash",
      desc: "Deleted contacts are kept for 30 days — restore one here with everything attached",
      icon: "♻️",
      href: "/settings/trash",
    },
