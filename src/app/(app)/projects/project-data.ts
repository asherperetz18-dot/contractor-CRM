...
/**
 * Every project card for a company, with the money rolled up.
 *
 * Lifted out of the Projects page so the printable reports read the very
 * same figures the screen shows -- a printout that disagrees with the
 * page it was printed from is how a report loses the reader's trust.
 */
